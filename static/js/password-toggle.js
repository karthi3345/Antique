document.addEventListener('DOMContentLoaded', () => {
  ...
  passwordInputs.forEach(input => {
    // Make sure parent is relative for absolute positioning of the icon
    ...
    // Align with input vertical center. Depending on the label, top might need adjustment.
    // Assuming input is the last element or we can just align to bottom
